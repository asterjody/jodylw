  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={portoImg} alt='/' />
        ...
        <div className='max-w-[1240px] mx-auto p-3 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                This application is made to provide an explanation about myself both in terms of
                 general information, skills, projects that I have worked on and information 
                 about how to contact me.
                </p>
                <button className='font-semibold px-8 py-2 mt-6 hover:scale-105 ease-in duration-300'>
                    <a href='https://jodylw.vercel.app'>
                        Preview
                    </a>
                </button>
            </div>
            <div className='col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4'>
                <div className='p-2'>
                    ...
                    <div className='grid grid-cols-3 md:grid-cols-1'>
                        ...
                        <p className='text-gray-600 py-2 flex items-center'>
                            <RiRadioButtonFill className='pr-1' />Getform.io
                        </p>
                    </div>
                </div>
            </div>
