    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-3 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            This application was built using React.js and deployed on Vercel. In
            this application the user can play a game, where the user must match
            the next alphabet according to the previous alphabet. If the game is
            finished the user can restart the game by pressing the restart
            button.
          </p>
          <button className="font-semibold px-8 py-2 mt-6 hover:scale-105 ease-in duration-300">
            <a href="https://abcdefgame.vercel.app">Preview</a>
          </button>
        </div>
