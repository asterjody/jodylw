  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={jsgamingImg} alt='/' />
        ...
        <div className='max-w-[1240px] mx-auto p-3 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <p>This application was built using MongoDB, Express.js, React.js, Node.js and deployed on Vercel.
                In this application, users can make a top-up process for selected games and view transaction history
                </p>
                <p className='py-2'>
                Meanwhile, in this application the admin can manage game 
                data, categories, vouchers, banks, payments
                and member transaction history
                </p>
                <button className='font-semibold px-8 py-2 mt-6 hover:scale-105 ease-in duration-300'>
                    <a href='https://jsgaming.vercel.app'>
                        ON PROGRESS..
                    </a>
                </button>
            </div>
