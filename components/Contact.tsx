...
const Contact = () => {
  return (
    <div id="contact" className="w-full p-10 lg:h-screen">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4">
            <div className="lg:p-4 h-full ">
              ...
              <div>
                <h2 className="py-2">Jody Leonardo Wijaya</h2>
                <p className="font-semibold">Web Developer</p>
                <p className="py-4">
                  I am available for full-time or internship positions. Contact
                  me and let&apos;s talk.
                </p>
              </div>
              <div>
          ...
          <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4">
            <div className="p-4">
              <form
                action="https://getform.io/f/d2c0cf3c-e63e-4c7e-948b-dd911650def7"
                method="POST"
        ...
        <div className="flex justify-center py-12">
          <Link href="/">
            <div className="rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer hover:scale-110 ease-in duration-300">
              <HiOutlineChevronDoubleUp className="text-[#044cd0]" size={30} />
            </div>
          </Link>
        </div>
      </div>
