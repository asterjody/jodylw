    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-3 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            This application was built using Bootstrap, PHP, MySQL and deployed
            on free hosting called byethost. In this application the user can
            view information about the Montana Car Wash profile, see information
            on the queue that is running and also make a reservation to do a
            vehicle wash.
          </p>
          <p className="py-2">
          ...
          <button className="font-semibold px-8 py-2 mt-6 hover:scale-105 ease-in duration-300">
            <a href="http://montanacarwash.byethost15.com">Preview</a>
          </button>
        </div>
