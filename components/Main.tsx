      ...
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <h1 className="py-1 text-gray-700">
            Hi, My Name is <span className="text-[#044CD0]">Jody</span>
          </h1>
          <h1 className="py-1 text-gray-700">A Web Developer</h1>
          <p className="py-3 text-gray-600 max-w-[70%] m-auto">
            I&apos;m a Web Developer specializing in building and designing web
            applications. Currently, I&apos;m focused on developing my skills to
