      ...
      <div className="max-w-[1240px] mx-auto p-3 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            ...
            and deployed on Vercel. In this application users are able to search
            movies. Users will be able to view trailer of the movie. Movies data
            were provided by TMDB API.
          </p>
          <button className="font-semibold px-8 py-2 mt-6 hover:scale-105 ease-in duration-300">
            <a href="https://jlplus.vercel.app">Preview</a>
          </button>
        </div>
