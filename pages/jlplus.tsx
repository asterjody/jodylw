...
import JlplusImg from'../public/assets/projects/jlplus.jpg'
  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={JlplusImg} alt='/' />
            <div className='absolute top-[70%] max-w-[1240px] w-full 
            left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%]
            text-white z-10 p-4'>
                <h2 className='py-2'>JL+ Movie</h2>
        ...
        <div className='max-w-[1240px] mx-auto p-3 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <p>This application was built using Next.js, Tailwind CSS, Typescript and deployed on Vercel.
                    In this application users are able to search movies. Users will be able to view trailer of the movie.
                    Movies data were provided by TMDB API.
                </p>
                <button className='font-semibold px-8 py-2 mt-6 hover:scale-105 ease-in duration-300'>
                    <a href='https://jlplus.vercel.app'>
                        Preview
                    </a>
                </button>
            </div>
